 ...
 * @file large_bus.h
 *
 * @brief The LargeBus class is identical to it's parent (Bus) with the
 * exception that LargeBus has a capacity of 90 passengers.
 *
...
class LargeBus : public Bus {
 public:
   /**
   * @brief Constructor for a large bus which has a capacity of 90 passengers
   */
