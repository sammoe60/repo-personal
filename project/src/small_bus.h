 ...
 * @file small_bus.h
 *
 * @brief The SmallBus class is identical to it's parent (Bus) with the
 * exception that SmallBus has a capacity of 30 passengers.
 *
...
class SmallBus : public Bus {
 public:
   /**
   * @brief Constructor for a small bus which has a capacity of 30 passengers
   */
